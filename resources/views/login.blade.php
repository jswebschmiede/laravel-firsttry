<x-layout>
    ...
    @section('content')
        ...
        <div class="max-w-96 mx-auto w-full flex justify-center items-center h-full">
            <form class="p-8 border w-full border-slate-200 rounded-md shadow-md" action="{{ route('login') }}" method="POST">
                @csrf
